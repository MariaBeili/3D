...
const Vector3& Player::getMovementDirection()
{
    ...
    if (!World::instance) {
        std::cout << "CRITICAL ERROR: World::instance is null in getMovementDirection!" << std::endl;
        static Vector3 zero_vec(0, 0, 0);
        return zero_vec;
    }
    ...
    if (!camera) {
        std::cout << "ERROR: Camera is null in getMovementDirection!" << std::endl;
        static Vector3 zero_vec(0, 0, 0);
        return zero_vec;
    }
    ...
    std::cout << "Movement direction: " << result.x << ", " << result.y << ", " << result.z << std::endl;
...
{
    std::cout << "Player::isGrounded() called. Position: " << new_position.x << ", " << new_position.y << ", " << new_position.z << std::endl;

    if (!World::instance) {
        std::cout << "CRITICAL ERROR: World::instance is null in isGrounded!" << std::endl;
        return false;
    }

    if (!World::instance->myscene) {
        std::cout << "ERROR: myscene is null in isGrounded!" << std::endl;
        return false;
    }
    ...
    if (collision_result) {
        ...
        std::cout << "Grounded - collision point: " << col_point.x << ", " << col_point.y << ", " << col_point.z << std::endl;
        return true;
    }

    std::cout << "Not grounded - no collision detected" << std::endl;
    return false;
}
